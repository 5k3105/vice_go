...
rem generate_msvc8_sdl2x.bat - generate MSVC8/VS2005 SDL2.x project directory
rem
rem Written by
...
cd ..\..\sdl
copy msvc-files\make-bindist-sdl2x.bat.proto win32-sdl2x-msvc8\make-msvc-bindist.bat
