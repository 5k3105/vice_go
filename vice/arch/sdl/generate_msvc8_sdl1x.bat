...
rem generate_msvc8_sdl1x.bat - generate MSVC8/VS2005 SDL1.x project directory
rem
rem Written by
...
cd ..\..\sdl
copy msvc-files\make-bindist-sdl1x.bat.proto win32-sdl1x-msvc8\make-msvc-bindist.bat
